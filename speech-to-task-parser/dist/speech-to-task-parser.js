...
exports.createTaskParser = createTaskParser;
...
class SpeechToTaskParser {
     ...
     */
    async parseSpeechtToTask(audioData) {
        try {
...
`;
     ...
     */
    async startContinuousListening(onTaskDetected, onError) {
     ...
     */
    async parseSmartGlassesContext(text, isFromOtherPerson = false) {
        const contextPrompt = `
...
// Usage example
async function createTaskParser(geminiApiKey) {
...
exports.default = SpeechToTaskParser;
//# sourceMappingURL=speech-to-task-parser.js.map