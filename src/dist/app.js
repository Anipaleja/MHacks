...
var initialNotes = [];
function App() {
    var _a = react_1.useState(initialNotes), notes = _a[0], setNotes = _a[1];
    var _b = react_1.useState(initialTasks), tasks = _b[0], setTasks = _b[1];
    var _c = react_1.useState(false), isListening = _c[0], setIsListening = _c[1];
    var _d = react_1.useState(""), transcript = _d[0], setTranscript = _d[1];
    ...
    react_1.useEffect(function () {
        if (typeof window !== 'undefined' && ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window)) {
            ...
            recognitionRef.current.onresult = function (event) {
                ...
                if (finalTranscript) {
                    var lowerTranscript = finalTranscript.toLowerCase().trim();
                    ...
                    if (lowerTranscript.includes('hey snap')) {
                        ...
                        if (command.includes('add task') || command.includes('new task') || command.includes('task')) {
                            ...
                            setTasks(function (prevTasks) { return __spreadArrays(prevTasks, [newTask_1]); });
                        }
                            ...
                            setNotes(function (prevNotes) { return __spreadArrays(prevNotes, [newNote_1]); });
                        }
                        else if (command) {
                            ...
                            setTasks(function (prevTasks) { return __spreadArrays(prevTasks, [newTask_2]); });
                        }
                    }
    ...
    var handleAddTask = function () {
        ...
        setTasks(function (prevTasks) { return __spreadArrays(prevTasks, [newTask]); });
    };
    var handleAddNote = function () {
        ...
        setNotes(function (prevNotes) { return __spreadArrays(prevNotes, [newNote]); });
    };
    var handleAddRecording = function () {
        if (isListening) {
            stopListening();
        }
        else {
    ...
    return (react_1["default"].createElement("div", { className: "container" },
        isListening && (react_1["default"].createElement("div", { className: "speech-status" }, "\uD83C\uDFA4 Listening for \"Hey Snap\"... Say: \"Hey Snap add task [task name]\" or \"Hey Snap add note [note text]\"")),
        react_1["default"].createElement("div", { className: "main-content" },
            react_1["default"].createElement("div", { className: "sidebar" },
                react_1["default"].createElement("div", { className: "header-row" },
                    react_1["default"].createElement("button", { onClick: handleAddTask, className: "add-button" }, "\u2795"),
                    react_1["default"].createElement("h3", null, "\uD83D\uDCCB Tasks")),
                react_1["default"].createElement("ul", { className: "list" }, tasks.map(function (task) { return (react_1["default"].createElement("li", { key: task.id, className: "list-item" }, task.text)); })),
            ...
            react_1["default"].createElement("div", { className: "center" },
                ...
                react_1["default"].createElement("button", { onClick: handleAddRecording, className: "voice-button " + (isListening ? 'listening' : '') }, isListening ? '🔴 Stop' : '🎤 Voice')),
            react_1["default"].createElement("div", { className: "sidebar" },
                react_1["default"].createElement("div", { className: "header-row" },
                    react_1["default"].createElement("button", { onClick: handleAddNote, className: "add-button" }, "\u2795"),
                    react_1["default"].createElement("button", { onClick: handleAddRecording, className: "add-button" }, isListening ? '🔴' : '🗣️'),
